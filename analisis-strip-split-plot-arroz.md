...
<style>
:root { --ink: #24324a; --blue: #1769aa; --teal: #00897b; --gold: #f4a261; --coral: #e76f51; --paper: #fffaf2; }
body { background: linear-gradient(135deg, #fffaf2 0%, #eef8f6 52%, #f5f0ff 100%); color: var(--ink); font-family: "Segoe UI", sans-serif; line-height: 1.65; }
.container-fluid { max-width: 1180px; padding: 2.5rem 4rem; }
h1 { color: #17324d; border-bottom: 5px solid var(--gold); padding-bottom: .45em; }
h2 { color: var(--blue); border-left: 8px solid var(--teal); padding-left: .65em; margin-top: 2.2em; }
h3 { color: var(--coral); }
code { color: #8b3a62; background: #fff0f3; border-radius: 4px; padding: .12em .3em; }
pre { background: #172a3a; color: #eef8f6; border: 0; border-left: 6px solid var(--gold); border-radius: 8px; box-shadow: 0 8px 22px #24324a22; padding: 1.2em; }
.sourceCode { margin-bottom: 1.5rem; }
table { background: #ffffffdd; border-collapse: collapse; box-shadow: 0 5px 18px #24324a18; }
th { background: var(--blue); color: white; }
th, td { padding: .65em .9em; border: 1px solid #d8e3ea; }
blockquote { background: #fff3d6; border-left: 6px solid var(--gold); padding: .8em 1.2em; }
img { display: block; margin: 1.4rem auto; border-radius: 10px; box-shadow: 0 8px 22px #24324a25; }
@media (max-width: 700px) { .container-fluid { padding: 1.2rem; } }
</style>
...
```{r croquis, fig.cap="Croquis de campo del experimento strip-split-plot."}
desplot(
  dat,
  gen ~ col * row,
  out1 = rep,
